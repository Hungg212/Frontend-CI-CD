  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-cream-50 px-6 text-center dark:bg-coffee-950">
      <div className="relative mb-8">
        ...
        <span className="absolute -right-2 -top-2 rounded-full bg-coffee-700 px-3 py-1 text-xs font-semibold text-cream-50">
          404
        </span>
      </div>
      ...
      <p className="mb-8 max-w-md text-base text-coffee-600 dark:text-cream-300">
        We couldn't find the page you were looking for. The link may be broken, or the page may have
        been moved.
      </p>
