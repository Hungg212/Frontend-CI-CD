...
const arrowClasses: Record<TooltipPosition, string> = {
  ...
  bottom: 'bottom-full left-1/2 -translate-x-1/2 border-b-stone-800 dark:border-b-zinc-700 border-l-transparent border-r-transparent border-t-transparent',
  ...
  right: 'right-full top-1/2 -translate-y-1/2 border-r-stone-800 dark:border-r-zinc-700 border-t-transparent border-b-transparent border-l-transparent',
};
